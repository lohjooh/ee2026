...
HD_PWD='C:/Users/seets/OneDrive/Desktop/joohoe/MenuLogicTrial/MenuLogicTrial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_menu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Main_menu.tcl -notrace
