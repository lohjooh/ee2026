...
HD_PWD='C:/Users/seets/OneDrive/Desktop/joohoe/MenuLogicTrial/MenuLogicTrial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_menu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_menu.tcl
